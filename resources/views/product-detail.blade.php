                  ...
                  <div class="aa-product-view-slider">
                    <div id="demo-1" class="simpleLens-gallery-container">
                      <div class="simpleLens-container">
                        <div class="simpleLens-big-image-container"><a data-lens-image="{{ asset('aset/img/view-slider/large/polo-shirt-1.png') }}" class="simpleLens-lens-image"><img src="img/view-slider/medium/polo-shirt-1.png" class="simpleLens-big-image"></a></div>
                      </div>
                      <div class="simpleLens-thumbnails-container">
                          <a data-big-image="{{ asset('aset/img/view-slider/medium/polo-shirt-1.png') }}" data-lens-image="{{ asset('aset/img/view-slider/large/polo-shirt-1.png') }}" class="simpleLens-thumbnail-wrapper" href="#">
                            <img src="{{ asset('aset/img/view-slider/thumbnail/polo-shirt-1.png') }}">
                          </a>
                          <a data-big-image="{{ asset('aset/img/view-slider/medium/polo-shirt-3.png') }}" data-lens-image="{{ asset('aset/img/view-slider/large/polo-shirt-3.png') }}" class="simpleLens-thumbnail-wrapper" href="#">
                            <img src="{{ asset('aset/img/view-slider/thumbnail/polo-shirt-3.png') }}">
                          </a>
                          <a data-big-image="{{ asset('aset/img/view-slider/medium/polo-shirt-4.png') }}" data-lens-image="{{ asset('aset/img/view-slider/large/polo-shirt-4.png') }}" class="simpleLens-thumbnail-wrapper" href="#">
                     ...
                     <li>
                        <div class="media">
                          <div class="media-left">
                            <a href="#">
                              <img class="media-object" src="{{ asset('aset/img/testimonial-img-3.jpg') }}" alt="girl image">
                            </a>
                          </div>
                            ...
                            <div class="simpleLens-gallery-container" id="demo-1">
                              <div class="simpleLens-container">
                                  <div class="simpleLens-big-image-container">
                                      <a class="simpleLens-lens-image" data-lens-image="{{ asset('aset/{{ asset('aset/img/view-slider/large/polo-shirt-1.png') }}') }}">
                              ...
                              <div class="simpleLens-thumbnails-container">
                                  <a href="#" class="simpleLens-thumbnail-wrapper"
                                     data-lens-image="{{ asset('aset/{{ asset('aset/img/view-slider/large/polo-shirt-1.png') }}') }}"
